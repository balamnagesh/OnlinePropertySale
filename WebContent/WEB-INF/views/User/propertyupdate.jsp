...
<div align="center">
<form:form action="propertysuccess.html"   enctype="multipart/form-data" method="post" >
...
<tr><td cssStyle="height:20px">Property Type</td><td cssStyle="width:18px;">:</td>
		<td><form:select path="propertytype" cssClass="txt" id="propertytype" cssStyle="width:162px;height:23px">
...
<td> <input type="file"  name="file" id="file"  multiple="multiple"></input> </td><td style="color:red;"><form:errors path="file" cssClass="error" /></td>  </tr>        
            <tr></tr>
            <tr></tr>
...
<tr></tr><tr></tr><tr></tr><tr></tr><tr><td></td>
	<!-- <td><input type="submit" value="Add" >&nbsp&nbsp&nbsp&nbsp -->
