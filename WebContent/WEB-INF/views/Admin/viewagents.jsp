...
window.open('addagent.html', 'AddAgent','height=850,width=900,left=200,top=100,overflow: scroll');
...
function conversion()
{
window.location.href="conversion999.html"; 
}  
</script> 
 <script>
function conversionofpdf()
{
window.location.href="conversionofpdf999.html"; 
}  
</script> 
<script>
function conversionofexcel()
{
window.location.href="conversionofexcel999.html"; 
}  
</script> 
<script>
function conversionofcsv()
{
window.location.href="conversionofcsv999.html"; 
}  
</script> 
<script>
function conversionofdoc()
{
window.location.href="conversionofdoc999.html"; 
}  
</script> 
<script>
function conversionoftext()
{
window.location.href="conversionoftext999.html"; 
}  
</script> 
<script>
function conversionofxml()
{
window.location.href="conversionofxml999.html"; 
}  
</script> 
<script>
function importingxmlfile()
{
	
	window.open('openjsp.html', 'imoport','height=850,width=900,left=200,top=100,overflow: scroll');

/* window.location.href="importingxmlfile999.html"; 
 */}  
</script> 
	...
	//window.open('updateagent.html', 'AddUser','height=700,width=700,left=200,top=100,overflow: scroll');
     ...
     var row = $('#tb').datagrid('getSelected');
        if (row){
         ...
         window.open('updateagent.html?username='+row.username,'UpdateAgent','height=850,width=800,left=200,top=100,overflow: scroll');                              
                    }
                   else
                 {
          ...
          /*    alert("multiple delete valuessss");  */
             ...
             $.messager.confirm('My Title', 'Are you sure you want to delete this user?', function(r){
                 if (r)
                 {
             window.location.href="admindelagent.html?username="+err
                 }
                });
             }
             else
 ...
 */
        	$('#tb').datagrid({
            	...
            	url:"adminagentgridsearch.html?value="+value
            });
...
function dateSearch(){
	...
	$('#tb').datagrid({
		url:"adminagentgriddate.html?from="+fr+"&to="+to
...
<center>
   <!--  <table id="tb" class="easyui-datagrid" title="All Agents" style="width:900px;height:300px" 
    
    	   onCheck="true" singleSelect="true" 
    	
          rownumbers="true" pagination="true" pageList="[10,20,30,40,50,60]"  showPageList="true" fitColumns="false"  data-options="singleSelect:false,url:'agentsgrid.html',onDblClickRow:function(index,row){update()},method:'get'">
          
           -->
    <table id="tb" class="easyui-datagrid" title="AgentsList" style="width:1100px;height:250px" singleSelect="false"  rownumbers="true" pagination="true" fitColumns="false" data-options="singleSelect:false,url:'agentsgrid.html',onDblClickRow:function(index,row){update()},method:'get'">
...
<div>
Search:  <input class="easyui-searchbox" data-options="prompt:'Please Input Username',searcher:doSearch" style="width:150px"/>Date Of Joining From:<input id="fromdate" class="easyui-datebox"  style="width:100px;"
...
<tr>
               ...
               <th align="center" data-options="field:'dateofjoining',width:90,align:'right'">DateofJoining</th>
               <th align="center" data-options="field:'mobileno',width:90">Mobilenumber</th>
                ...
                <th align="center" data-options="field:'city',width:90">City</th>
                  ...
                  <th align="center" data-options="field:'language',width:100">Languages Knwon</th>
 ...
 <!-- <div style="margin:20px 0;"></div>
    ...
    <div style="margin:20px 0;"  align="center"> 
        ...
        <div style="margin:10px 0;"  align="center"> 
         <input type="button" name="EXPORT TO HTML" value="EXPORT TO HTML" onclick="conversion()" class="button">
         <input type="button" name="EXPORT TO PDF" value="EXPORT TO PDF" onclick="conversionofpdf()" class="button">
         <input type="button" name="EXPORT TO EXCEL" value="EXPORT TO EXCEL" onclick="conversionofexcel()" class="button">
         <input type="button" name="EXPORT TO CSV" value="EXPORT TO CSV" onclick="conversionofcsv()" class="button">
          <input type="button" name="EXPORT TO DOC" value="EXPORT TO DOC" onclick="conversionofdoc()" class="button">
          <input type="button" name="EXPORT TO TEXT" value="EXPORT TO TEXT" onclick="conversionoftext()" class="button">
<!--            <input type="button" name="EXPORT TO XML" value="EXPORT TO XML" onclick="conversionofxml()" class="button">
 -->            <input type="button" name="IMPORT XML FILE" value="IMPORT XML FILE" onclick="importingxmlfile()" class="button">
       </div>
       </sec:authorize>
</body>
</html>