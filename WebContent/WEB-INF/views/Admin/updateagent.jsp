...
<tr>
<td><form:hidden path="password" /></td><td><form:errors path="" cssClass="error"></form:errors></td></tr>

<tr>
<td><form:hidden path="conformpassword"/></td><td><form:errors path="" cssClass="error"></form:errors></td></tr>
<tr>
