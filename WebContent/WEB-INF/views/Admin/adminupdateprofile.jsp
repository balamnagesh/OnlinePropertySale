...
<div align="center">
<br>
<form:form action="adminupdateprofilesucc.html" method="POST">
...
<td><form:input path="city" cssClass="txt" cssStyle="height:18px;"/></td><td><form:errors path="city" cssClass="error"></form:errors></td></tr>
  ...
  <tr>
       <td cssStyle="height:20px">Languages Known</td><td cssStyle="width:18px;">:</td>
        <td><form:checkbox path="language" value="telugu" id="telugu"/>Telugu
        <form:checkbox path="language" value="hindi" id="hindi"/>Hindi
        <form:checkbox path="language"  value="english" id="english"/>English</td>
      <td><form:errors path="language" cssClass="error"></form:errors></td></tr>
...
<tr><td><form:hidden path="registerdate"/></td></tr>
