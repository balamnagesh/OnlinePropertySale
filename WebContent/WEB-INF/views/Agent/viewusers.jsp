...
window.open('adduser.html', 'AddAgent','height=850,width=900,left=200,top=100,overflow: scroll');
	...
	//window.open('updateagent.html', 'AddUser','height=700,width=700,left=200,top=100,overflow: scroll');
     ...
     var row = $('#tb').datagrid('getSelected');
        if (row){
         ...
         window.open('updateuser.html?username='+row.username,'UpdateAgent','height=850,width=800,left=200,top=100,overflow: scroll');                              
                    }
                   else
                 {
          ...
          /*    alert("multiple delete valuessss");  */
            ...
            /*  alert(row.length); */
             ...
             $.messager.confirm('My Title', 'Are you sure you want to delete this user?', function(r){
                 if (r)
                 {
             window.location.href="agentdeluser.html?username="+err
                 }
                });
             }
             else
	...
	<script>
        function doSearch(value){
        	...
        	$('#tb').datagrid({
            	...
            	url:"agentusergridsearch.html?value="+value
            });
...
function dateSearch(){
	...
	$('#tb').datagrid({
		url:"agentusergriddate.html?from="+fr+"&to="+to
...
<center>
   <!--  <table id="tb" class="easyui-datagrid" title="All users" style="width:900px;height:300px" 
          ...
          rownumbers="true" pagination="true" pageList="[10,20,30,40,50,60]"  showPageList="true" fitColumns="false"  data-options="singleSelect:false,url:'usersgrid.html',onDblClickRow:function(index,row){update()},method:'get'"> -->
           ...
           <table id="tb" class="easyui-datagrid" title="UsersList" style="width:1100px;height:250px" singleSelect="false"  rownumbers="true" pagination="true" fitColumns="false" data-options="singleSelect:false,url:'agentsusersgrid.html',onDblClickRow:function(index,row){update()},method:'get'">
...
Register Date From:<input id="fromdate" class="easyui-datebox"  style="width:100px;"
...
<tr>
                ...
                <th align="center" data-options="field:'gender',width:70,align:'right'">Gender</th>
               ...
               <th align="center" data-options="field:'mobileno',width:90">Mobilenumber</th>
                ...
                <th align="center" data-options="field:'pincode',width:70,align:'right'">Pincode</th>
                ...
                <th align="center" data-options="field:'city',width:90">City</th>
                  <th align="center" data-options="field:'language',width:90">Languages Knwon</th>
                <th align="center" data-options="field:'registerdate',width:140,align:'right'">RegDate(yyyy-dd-mm)</th>
