...
<div align="center">
<form:form action="agentpropertysuccess.html"   enctype="multipart/form-data" method="post" >
...
<tr><td cssStyle="height:20px">City</td><td >:</td>
...
<td> <input type="file"  name="file" id="file"  multiple="multiple"></input> </td><td style="color:red;"><form:errors path="file" cssClass="error" /></td>  </tr>        
 ...
 <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
 <input type="submit" value="Add" Class="button"/>&nbsp&nbsp&nbsp&nbsp
...
<%-- <tr>
		<td></td><td><input type="submit" value="Add" Class="button">&nbsp&nbsp&nbsp&nbsp
<input type="button" value="Reset" Class="button" onclick="reset11();"></td></tr>
