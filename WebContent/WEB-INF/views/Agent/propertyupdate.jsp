   ...
   function getStates(country)
{
    ...
    <script>
     ...
     <script> 
     setTimeout(propertytype,1000);
     function propertytype()
     {
   		 for(var i=0;i<document.getElementsByName("propertytype")[0].length;i++)
   		 {
   		 	if('${command.propertytype}'==document.getElementsByName("propertytype")[0].options[i].value)
   		 	{
   		 		document.getElementsByName("propertytype")[0].options[i].selected=true;
   		 		getStates(document.getElementsByName("propertytype")[0].options[i].value);
   		 		setTimeout(select,100);
   		 	}
   		 }
     }</script>
...
<script type="text/javascript">
							...
							function chooseFile(){
								...
								a.src =document.getElementById('fileInput').value;
								document.getElementById('producturl').value=a.src;
							};
						</script>
...
<div align="center">
<form:form action="agentpudatepropertysuccess.html"   enctype="multipart/form-data" method="post" >

<table border="0" align="center" cellpadding="3" cellspacing="2">

<%-- <tr><td cssStyle="height:20px">Owner</td><td cssStyle="width:18px;">:</td>
<td><form:input path="id" cssClass="txt" cssStyle="height:18px;" id="pid" readonly="true"/></td><td><form:errors path="id" cssClass="error"></form:errors></td></tr>
<tr><td cssStyle="height:20px">Owner</td><td cssStyle="width:18px;">:</td>
<td><form:input path="owner" cssClass="txt" cssStyle="height:18px;" id="owner"/></td><td><form:errors path="owner" cssClass="error"></form:errors></td></tr>
...
<form:hidden path="id"/>
<tr><td cssStyle="height:20px">Property Country</td><td cssStyle="width:18px;">:</td>
     ...
     <tr>  
      <td cssStyle="height:20px"> Property State</td><td cssStyle="width:18px;">:</td> 
...
<%-- <tr><td cssStyle="height:20px">Locality</td><td cssStyle="width:18px;">:</td>
<td><form:input path="locality" cssClass="txt" cssStyle="height:18px;" id="locality"/></td><td><form:errors path="locality" cssClass="error"></form:errors></td></tr>
 --%>
...
<tr><td cssStyle="height:20px">Property Type</td><td cssStyle="width:18px;">:</td>
		<td><form:select path="propertytype" cssClass="txt" id="propertytype" cssStyle="width:162px;height:23px"  onchange="getProperty(this.value);">
								  <option value="">Select Property Type</option>
								  <option value="residentialland">Residential House</option>
     ...
     <td><form:errors path="propertytype" cssClass="error" /></td>
     </tr>

<tr><td cssStyle="height:20px">Plot-area</td><td cssStyle="width:18px;">:</td>
<td><form:input path="plotarea" cssClass="txt" cssStyle="height:18px;" id="plotarea"/></td><td><form:errors path="plotarea" cssClass="error"></form:errors></td></tr>

<tr><td cssStyle="height:20px">Property Price</td><td cssStyle="width:18px;">:</td>
<td><form:input path="propertyprice" cssClass="txt" cssStyle="height:18px;" id="propertyprice"/></td><td><form:errors path="propertyprice" cssClass="error"></form:errors></td></tr>

<%-- <tr><td cssStyle="height:20px">Location Longitude</td><td cssStyle="width:18px;">:</td>
<td><form:input path="longtude" cssClass="txt" cssStyle="height:18px;" id="city"/></td><td><form:errors path="longtude" cssClass="error"></form:errors></td></tr>

<tr><td cssStyle="height:20px">Location Latitude</td><td cssStyle="width:18px;">:</td>
<td><form:input path="latitude" cssClass="txt" cssStyle="height:18px;" id="city"/></td><td><form:errors path="latitude" cssClass="error"></form:errors></td></tr>
 --%>
...
<td> <input type="file"  name="file" id="fileInput" value="command.filepath" multiple="multiple" size="21" onchange="readURL(this)"></input> </td><td style="color:red;"><form:errors path="file" cssClass="error" />       
      	<div>
	 						<div width="50px;" height="30px;" border=1 id="dd1" ></div>
	 						<img src="images/${command.filepath}" width="100" height="100" id="dd">  </td>  </tr>    
					...
					function readURL(input) {
						...
						var ss=document.getElementById("fileInput").value;
							...
							if (input.files && input.files[0]) {
								alert("..........enter into if loop");
							var reader = new FileReader();
							
							reader.onload = function (e) {
							
							   var foo = document.getElementById("dd").src=e.target.result;
							};
							...
							else
							{
							     ...
							     document.getElementById("dd").src=input.value;
...
<tr><td></td>
 ...
 <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
 <input type="submit" value="Update" Class="button"/>&nbsp&nbsp&nbsp&nbsp
 <input type="button" value="Reset" onClick="reset11()" Class="button"/></td> </tr>
...
<%-- <tr></tr><tr></tr><tr></tr><tr></tr><tr><td></td>
	
		<td><input type="submit" value="Add" Class="button">&nbsp&nbsp&nbsp&nbsp
<input type="button" value="Reset" Class="button" onclick="reset();"></td>
</table>
 </form:form> --%>
