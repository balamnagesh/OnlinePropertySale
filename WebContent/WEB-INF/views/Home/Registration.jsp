...
<div align="center">
<form:form action="registersuccess.html" method="POST">
...
<td><form:input path="mobileno" cssClass="txt" cssStyle="height:18px;" styleId="mobileno"  onchange="uniqueemail()"/></td><td><form:errors path="mobileno" cssClass="error"></form:errors></td></tr>
