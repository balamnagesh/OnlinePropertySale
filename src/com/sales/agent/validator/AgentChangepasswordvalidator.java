...
public class AgentChangepasswordvalidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		AgentRegistration r=(AgentRegistration)target;
	...
	//............conformpassword..............
		...
		else if(password.equals(oldpwd)){
			errors.rejectValue("password","errors.password.match","New Password not same as old password");
