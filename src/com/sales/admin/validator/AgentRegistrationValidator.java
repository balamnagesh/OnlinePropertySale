...
import com.sales.home.bean.Registration;
   ...
   public class AgentRegistrationValidator implements Validator
   {

	@Override
	public boolean supports(Class<?> clazz) {
		System.out.println("coming to support method");
		return AgentRegistration.class.isAssignableFrom(clazz);
	}
	...
	public void validate(Object ob, Errors errors) 
	{
		...
		AgentRegistration rb=(AgentRegistration)ob;
		  String id=rb.getId();
		  //System.out.println(rb.getId());
		 	...
		 	String doj=rb.getDateofjoining();		
						   ...
						   else if (!address.matches("^(?!.*?[:.,/ _-]{2})[a-zA-Z0-9 :.,/_-]+$"))
						   {
			        		...
			        		//.................dateofjoining
							 if(doj==null||doj.trim().equals("")){
								 errors.rejectValue("dateofjoining", "errors.dateofjoining.required", "DateOfJoining is required");
							 }
							 else
								{	 
									 try
									 {
										  ...
										  DateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
										   ...
										   int  yr=date.getYear()+1900;
									     	...
									     	if ((ny ==0 && nm == 0 && nd < 0)||(ny==0 && nm<0 && nd<=nd) || ny< 0)
									     	{
									     		errors.rejectValue("dateofjoining", "errors.dateofbirth.feature", " Feature date is not allowed.");
									           
									        }
									     	/*else if ((ny == 18 && nm == 0 && nd < 0)||(ny==18 && nm<0 && nd<=nd) || ny< 18) 
									     	{
									     		errors.rejectValue("dateofjoining", "errors.dateofbirth.below", "Age must be greater than 18 years.");
									        }*/
