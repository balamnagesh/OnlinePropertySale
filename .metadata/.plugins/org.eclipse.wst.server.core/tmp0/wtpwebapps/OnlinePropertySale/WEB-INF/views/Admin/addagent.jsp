...
<br>
<br>
<h2 align="center">Agent Registration</h2>
<div align="center">
<form:form action="addagentsuccess.html" method="POST">
...
<td><form:input path="dateofjoining" class="easyui-datebox"  cssStyle="txt:height:12px;" id="dateofjoining" editable="false"/></td><td><form:errors path="dateofjoining" cssClass="error"></form:errors></td></tr>
