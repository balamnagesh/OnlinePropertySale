...
<center>
              ...
              <table id="tb" class="easyui-datagrid" title="UsersList" style="width:1100px;height:250px" singleSelect="false"  rownumbers="true" pagination="true" fitColumns="false" data-options="singleSelect:false,url:'adminfeedbackgrid.html',onDblClickRow:function(index,row){update()},method:'get'">
