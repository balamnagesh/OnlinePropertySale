 ...
 */
        	$('#tb').datagrid({
            	...
            	url:"userpropertygrididserach.html?value="+value
            });
...
function dateSearch(){
	...
	$('#tb').datagrid({
		url:"userpropertygriddate.html?from="+fr+"&to="+to
...
<center>
   <!--  <table id="tb" class="easyui-datagrid" title="All Properties" style="width:1000px;height:600px" 
          ...
          rownumbers="true" pagination="true" pageList="[10,20,30,40,50,60]"  showPageList="true" fitColumns="false"  data-options="singleSelect:false,url:'agentpropertylist.html',onDblClickRow:function(index,row){update()},method:'get'">
           -->
                      <table id="tb" class="easyui-datagrid" title="All Properties" style="width:1000px;height:600px" singleSelect="false"  rownumbers="true" pagination="true" fitColumns="false" data-options="singleSelect:false,url:'userpropertylist.html',onDblClickRow:function(index,row){update()},method:'get'">
