...
<br>
<br>
<h2 align="center">Update Agent</h2>
<div align="center">
<form:form action="updateagentsuccess.html" method="POST">
...
<td><form:input path="username" readonly="true" cssClass="txt" styleId="username" onchange="unique()" cssStyle="height:18px;" /></td><td><span id="sid" style="color:red"></span><form:errors path="username" cssClass="error"></form:errors></td></tr>
<tr>
<td><form:hidden path="password" /></td><td><form:errors path="password" cssClass="error"></form:errors></td></tr>

<tr>
<td><form:hidden path="conformpassword"/></td><td><form:errors path="conformpassword" cssClass="error"></form:errors></td></tr>
<tr>
...
<tr>
<tr><td cssStyle="height:20px">DateOfJoining</td><td cssStyle="width:18px;">:</td>
<td><form:input path="dateofjoining" class="easyui-datebox" readonly="true" cssStyle="txt:height:12px;" id="dateofjoining" editable="false"/></td></tr>
